(() => {
  const carousels = Array.from(document.querySelectorAll('.p-carousel'));
  ...
  carousels.forEach((carousel) => {
    ...
    const dotsC = carousel.querySelector('#destacadosDots') || document.querySelector('#destacadosDots');
    ...
    next && next.addEventListener('click', () => { if (page < pageCount - 1) { page++; update(); } });
